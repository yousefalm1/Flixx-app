const global = {
  ...
  api: {
    apiKey: '79ab262c7813d1d0dcd2574756214709',
...
<div class="details-bottom">
  ...
  <ul>
    ...
    <li><span class="text-secondary">First Episode To Air:</span> ${
      show.first_air_date
    }</li>
...
function displayPagination() {
  ...
  if (global.search.page === global.search.totalPages) {
    document.querySelector('#next').disabled = true; // Corrected this line
  }
...
function initSwiper() {
  const swiper = new Swiper('.swiper', {
    ...
    autoplay: {
      delay: 4000,
      disableOnInteraction: false, // corrected property name
    },
    breakpoints: {
      500: {
        slidesPerView: 2,
